...
This repository holds the evolving lives, lineages, and lore of the characters from **ZU X ORI**, the reincarnation-era sequel to *Romeo and Juliet*.
...
- **HERMES** – [View Profile](HERMES-profile.md): Trickster, prophet, friend. Mercutio reborn.  
- **TAI** – [View Profile](TAI-profile.md): Juliet's brother, bound by memory and vengeance. Tybalt reborn.  
- **LUCREZIA** – [View Profile](LUCREZIA-profile.md): Alchemist of scent. Guardian of memory. A ghost of friendship.  
...
These profiles represent the core, canon characters of the ZU X ORI story. While the world invites reinterpretation, remixing, and expansion, this repository holds the original character definitions.
...
Story and characters by Sov / ZU X ORI  
